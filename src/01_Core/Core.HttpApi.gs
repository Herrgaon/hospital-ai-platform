...
const GATEWAY_ACTIONS_ = {
  ...
  'employee.changeAssignment': function (user, params) { return changeEmployeeAssignment(user, params.employeeId, params.input); },
  'employee.addQualification': function (user, params) { return addQualification(user, params.employeeId, params.input); },
  'employee.removeQualification': function (user, params) { return removeQualification(user, params.qualificationId); },
  'employee.addAssignment': function (user, params) { return addEmployeeAssignment(user, params.employeeId, params.input); },
  'employee.endAssignment': function (user, params) { return endEmployeeAssignment(user, params.assignmentId); },

  'position.list': function () { return listActivePositions(); },
  'position.create': function (user, params) { return createPosition(user, params); },
  'position.deactivate': function (user, params) { return deactivatePosition(user, params.positionId); },
  'jobTitle.list': function () { return listActiveJobTitles(); },
  'jobTitle.create': function (user, params) { return createJobTitle(user, params); },
  'jobTitle.deactivate': function (user, params) { return deactivateJobTitle(user, params.jobTitleId); },
  ...
  'department.tree': function () { return getOrganizationTree(); },
  'department.detail': function (user, params) { return getDepartmentDetail(params.departmentId); },
  ...
  'task.createPersonal': function (user, params) { return createPersonalTask(user, params); },
  'task.completeMine': function (user, params) { return completeMyTask(user, params.taskId); },
  'task.cancel': function (user, params) { return cancelTask(user, params.taskId, params.reason); },
  'task.transferToNextPeriod': function (user, params) { return transferTaskToNextPeriod(user, params.taskId, params.newDueDate, params.reason); },
  'task.createRecurringTemplate': function (user, params) { return createRecurringTaskTemplate(user, params); },
  'task.pauseRecurringTemplate': function (user, params) { return pauseRecurringTaskTemplate(user, params.templateId); },
  'task.resumeRecurringTemplate': function (user, params) { return resumeRecurringTaskTemplate(user, params.templateId); },
  'task.endRecurringTemplate': function (user, params) { return endRecurringTaskTemplate(user, params.templateId); },
  'task.listMyRecurringTemplates': function (user) { return listMyRecurringTaskTemplates(user); },
  'task.listRecurringTemplatesByDepartment': function (user, params) { return listRecurringTaskTemplatesByDepartment(user, params.departmentId); },
  ...
  'attendancePeriod.create': function (user, params) { return createAttendancePeriod(user, params.departmentId, params.periodMonth); },
  'attendancePeriod.markDeptCompleted': function (user, params) { return markAttendancePeriodDeptCompleted(user, params.periodId); },
  'attendancePeriod.confirmByDeptHead': function (user, params) { return confirmAttendancePeriodByDeptHead(user, params.periodId); },
  'attendancePeriod.submit': function (user, params) { return submitAttendancePeriod(user, params.periodId); },
  'attendancePeriod.markUnderReview': function (user, params) { return markAttendancePeriodUnderReview(user, params.periodId); },
  'attendancePeriod.requestRevision': function (user, params) { return requestAttendancePeriodRevision(user, params.periodId, params.comment); },
  'attendancePeriod.lock': function (user, params) { return lockAttendancePeriod(user, params.periodId); },
  'attendancePeriod.listByDepartment': function (user, params) { return listAttendancePeriodsByDepartment(user, params.departmentId); },
  'attendancePeriod.getDetail': function (user, params) { return getAttendancePeriodDetail(user, params.periodId); },
  'attendancePeriod.dashboard': function (user) { return getAttendanceDashboard(user); },
  'attendancePeriod.reconciliation': function (user, params) { return getAttendancePeriodReconciliation(user, params.periodId); },
  'attendancePeriod.requestReopen': function (user, params) { return requestReopenAttendancePeriod(user, params.periodId, params.reason); },
  'attendancePeriod.approveReopen': function (user, params) { return approveReopenAttendancePeriod(user, params.requestId); },
  'attendancePeriod.rejectReopen': function (user, params) { return rejectReopenAttendancePeriod(user, params.requestId, params.reason); },
  'attendancePeriod.listPendingReopenRequests': function (user) { return listPendingAttendancePeriodReopenRequests(user); },
